      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-4">
        {loading ? (
          ...
          <>
            ...
            <StatCardItem label="Visitantes (30 dias)" value={stats.visitors > 0 ? formatNumber(stats.visitors) : "—"} change={0} icon={Globe} />
          ...
          <Card className="border-amber-500/50 bg-amber-500/5">
            <CardContent className="p-4">
              <p className="text-sm text-amber-600">
                ℹ️ Para ver métricas de visitantes aqui no dashboard, você precisa configurar as credenciais da API do Google Analytics. Siga o guia <strong>SETUP-GOOGLE-ANALYTICS-API.md</strong> na raiz do projeto.
              </p>
            </CardContent>
          </Card>
        </div>
