...
import seoSegmentsRoutes from "./routes/seo-segments.js";
...
import headerMenuRoutes from "./routes/header-menu.js";
...
app.use("/api/seo-segments", seoSegmentsRoutes);
app.use("/api/banners", bannersRoutes);
app.use("/api/settings", settingsRoutes);
app.use("/api/header-menu", headerMenuRoutes);
